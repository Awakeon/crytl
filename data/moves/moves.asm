...
Moves1:
	...
	move EFFECT_MULTI_HIT,          20, FAIRY,       PHYSICAL,   85, 10,   0      ;DOUBLESLAP
	move EFFECT_MULTI_HIT,          18, FLYING,       PHYSICAL,   85, 15,   0      ;COMET_PUNCH
	...
	move EFFECT_NORMAL_HIT,        120, NORMAL,       PHYSICAL,   85,  5,   0      ;MEGA_KICK
	move EFFECT_JUMP_KICK,          70, FIGHTING,     PHYSICAL,   100, 25,   0      ;JUMP_KICK
	move EFFECT_FLINCH_HIT,         60, FIGHTING,     PHYSICAL,   100, 15,  30      ;ROLLING_KICK
	...
	move EFFECT_SPIDERWEB,           0, BUG,          STATUS, 100, 10,   0      ;SPIDER_WEB
	...
	move EFFECT_MOONBLADE,          85, FAIRY,        PHYSICAL,  100, 10, 0        ;MOONBLADE
	move EFFECT_POISON_HIT,         70, POISON,       PHYSICAL,  100, 10, 10       ;CROSSPOISON
	move EFFECT_PRIORITY_HIT,       50, STEEL,        PHYSICAL,  100, 10, 0        ;BULLETPUNCH
	...
	move EFFECT_POISON_HIT,         80, POISON,       PHYSICAL, 100, 15, 30        ;POISON_JAB
	move EFFECT_PARALYZE_HIT,      100, ELECTRIC,     PHYSICAL, 100, 10, 0        ;SUPERCELLRAM
	move EFFECT_LEECH_HIT,          75, FIGHTING,    PHYSICAL, 100, 15, 0        ;DRAIN_PUNCH
	move EFFECT_PRIORITY_HIT,       40, ICE,    PHYSICAL, 100, 15, 0        ;ICE_SHARD
.IndirectEnd::
